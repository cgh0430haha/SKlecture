...
class Ui_HttpWidget(object):
    def setupUi(self, HttpWidget):
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("recommendation.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, HttpWidget):
        ...
        self.reload.setText(QtGui.QApplication.translate("HttpWidget", "추천", None, QtGui.QApplication.UnicodeUTF8))
